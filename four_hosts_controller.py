...
from ryu.lib.packet import in_proto, ipv4, icmp, udp, tcp
...
class Switch(app_manager.RyuApp):
    ...
    def switch_features_handler(self, ev):
        ...
        # match_icmp = parser.OFPMatch(eth_type=ether_types.ETH_TYPE_IP, ip_proto=1, out_port=2)
        # actions_icmp = [parser.OFPActionOutput(out_port)]
        # self.add_flow(datapath, 100, match_icmp, )

        # {protocol: in_switch_id, out_switch_id, in_port, out_port}
        # self.path = {"TCP": (1, 1, )}
    ...
    def get_action(self, dpid, protocol, in_port):
        pass
